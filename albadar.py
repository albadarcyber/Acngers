//Copyright Albadar
//Thanks To Badut Galau,Jester,Jhonythebay,Dapoy,Pleasure,Mb3_Sure
...
def main_menu():
       ...
       print (gt+"  ["+p+"1"+gt+"] "+p+"Tembak Kartu Xl")
       print (gt+"  ["+p+"2"+gt+"] "+p+"Lupa Sandi Telkomsel")
       print (gt+"  ["+p+"3"+gt+"] "+p+"Lihat Waktu")
